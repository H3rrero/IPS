...
public class AñadirReserva {
	...
	public void execute(String DNI_Socio, int ID_Instalacion,int Hora_Inicio,int Hora_fin, String horario,boolean cobro, double importe, int id_Actividad) throws ClassNotFoundException, SQLException {
		con.conectar();
